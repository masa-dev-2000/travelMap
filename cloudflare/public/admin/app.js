...
const shell=mapShell([
  ...
  {id:'add',label:'記録する',icon:'＋',nodes:[el('a',{className:'quick-record',href:'/admin/record/',textContent:'スマホ用の記録画面を開く →'}),$('#activity-form').closest('details'),$('#transaction-form').closest('details')]},
